...
import flag from "../../assets/Images/icon/16.png";
    ...
    <footer className="footer-wrapper">
      <div className="container">
        ...
        <div className="footer-links-wrapper row">
          <div className="col links-wrapper-1 col-sm-12 col-md">
          ...
          <div className="col links-wrapper-2 col-sm-12 col-md">
            <h3>Services</h3>
            <ul>
              <li>
          ...
          <div className="col links-wrapper-3 col-sm-12 col-md">
            <h3>Apple Store</h3>
            <ul>
              <li>
          ...
          <div className="col links-wrapper-4 col-sm-12 col-md">
            <h3>For Business</h3>
            <ul>
              <li>
          ...
          <div className="col links-wrapper-5 col-sm-12 col-md">
            <h3>Apple Values</h3>
            <ul>
              <li>
                <a href="#">Find a Store</a>
